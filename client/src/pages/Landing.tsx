...
const CALIA_LOGO = "https://d2xsxph8kpxj0f.cloudfront.net/310519663377716985/mbGHqRvCcm8pC8pAncoxX9/calia-logo_27ab85c2.jpeg";
      ...
      <footer className="border-t border-border/30 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <img src={CALIA_LOGO} alt="Calia" className="w-6 h-6 rounded object-contain" />
            <span className="text-sm text-muted-foreground">
              Cal.IA — Sistema Inteligente de Avaliação — caliadigital.com.br
            </span>
          </div>
